...
export default class AboutPage extends Component {
	render() {
		return (<Row>
			...
			<p>By attaching a NFC card to a library book, one can tap the book with a NFC enabled device to conveniently browse online resources related to the book. In the case of Deborah DeJong's book <Link to={`/publications/d-a-n-c-e-five-steps-to-living-your-best-life`}>D.A.N.C.E.: five steps to Living Your Best Life</Link>, the mobile friendly site provides information about the book, digital reading options, and exclusive interviews with fans.</p>
			<h3>Results</h3>
